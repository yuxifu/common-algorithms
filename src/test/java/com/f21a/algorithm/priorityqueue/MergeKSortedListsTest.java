...
public class MergeKSortedListsTest {
    ...
    @Test
    public void testMergeKSortedList2Example1() {
        ListNode l1 = ListNode.buildLinkedList(new int[]{1, 4, 5});
        ListNode l2 = ListNode.buildLinkedList(new int[]{1, 3, 4});
        ListNode l3 = ListNode.buildLinkedList(new int[]{2, 6});
        ListNode merged = new MergeKSortedLists().mergeKLists2(new ListNode[]{l1, l2, l3});
        assertEquals(Arrays.asList(1, 1, 2, 3, 4, 4, 5, 6), ListNode.printLinkedList(merged));
    }

    @Test
    public void testMergeKSortedList2Example2() {
        ListNode merged = new MergeKSortedLists().mergeKLists2(new ListNode[]{});
        assertEquals(Collections.emptyList(), ListNode.printLinkedList(merged));
    }

    @Test
    public void testMergeKSortedList2Example3() {
        ListNode l1 = ListNode.buildLinkedList(new int[]{});
        ListNode merged = new MergeKSortedLists().mergeKLists2(new ListNode[]{l1});
        assertEquals(Collections.emptyList(), ListNode.printLinkedList(merged));
    }
}
